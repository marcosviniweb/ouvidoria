...
@Component({
  ...
  templateUrl: './remocao.page.html',
  styleUrls: ['./remocao.page.scss'],
})
export class RemocaoPage implements OnInit {
  ...
  constructor(private authService: AuthService,
    ...
    this.fGroup = this.fBuilder.group({
      ...
      'endereco': [this.pedido.descricao],
      'descricao': [this.pedido.endereco],
  ...
  mostrarmapa() {
    ...
    const icon = {
      url: 'assets/imagens/icon/coleta.png',
  ...
  solicitacao(pedido) {
    ...
    if (this.pedido.descricao != '' && this.pedido.bairro != '' && this.pedido.endereco != '' && this.pedido.referencia) {
      ...
      let img = `https://firebasestorage.googleapis.com/v0/b/app-prefeitura.appspot.com/o/Coleta_Entulho%2F${this.protocolo}?alt=media`;
      this.pedido.situacao = "Aberto";
      // COLOCANDO O TIPO DE CATEGORIA DO PEDIDO
      this.pedido.categoria = "Coleta de Entulho";
  ...
  async tirarFoto() {
    ...
    let pictures = storage().ref(`Coleta_Entulho/${this.protocolo}`);
